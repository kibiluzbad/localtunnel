...
const DurableConnection = require('net-reconnect');
...
TunnelCluster.prototype.open = function () {
    ...
    const dcon = new DurableConnection(remote_port, remote_host);

    // Optionally change some defaults

    dcon.reconnectMillis = 300000;     // default: 1000
    dcon.maxReconnectMillis = 60000; // default: Number.MAX_SAFE_INTEGER

    var remote = dcon.connect();
